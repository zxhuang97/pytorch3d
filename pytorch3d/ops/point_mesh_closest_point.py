...
# PointFaceDistance
class _PointFaceClosestPoint(Function):
    """
    ...
    def forward(
        ...
        """
        dists, idxs, closest = _C.point_face_closest_point_forward(
            points,
            points_first_idx,
            tris,
            tris_first_idx,
    ...
    def backward(ctx, grad_dists):
        ...
        grad_points, grad_tris = _C.point_face_closest_point_backward(
            points, tris, idxs, grad_dists, min_triangle_area
        )
        return grad_points, None, grad_tris, None, None, None


point_face_closest_point = _PointFaceClosestPoint.apply

def point_mesh_closest_point(
        meshes: Meshes,
        pcls: Pointclouds,
